    ...
    <section id="hace-tu-pedido" className="px-4 sm:px-6 lg:px-8 py-16 lg:py-20 scroll-mt-24">
      <div className="w-full max-w-7xl mx-auto">
        <AnimateOnScroll>
          ...
          <p className="text-white/50 max-w-lg mb-12" style={{ fontSize: "clamp(0.95rem, 2vw, 1.1rem)" }}>
            ¿No encontrás lo que buscás en el catálogo? Lo traemos.
        ...
        <AnimateOnScroll delay={100}>
          <div className="rounded-2xl border border-white/5 bg-[#0f0f0f] p-8 sm:p-12 max-w-xl">
            ...
            <div className="flex flex-wrap gap-2 mb-8">
              {["Respuesta en 48hs", "Sin compromiso", "Envío a todo el país"].map((pill) => (
                <span
                  key={pill}
            ...
            <p className="text-white/60 text-sm leading-relaxed mb-8">
              Mandanos la marca y modelo por WhatsApp y te cotizamos en menos de 48 horas.
              Sin formularios, sin vueltas — solo escribinos y arrancamos.
            </p>
